...
const SuccessToast = ({
  ...
  return (
    <div
      className={`pointer-events-auto mx-auto mb-4 hidden w-96 max-w-full rounded-lg bg-success-100 bg-clip-padding text-sm text-success-700 shadow-lg shadow-black/5 data-[te-toast-show]:block data-[te-toast-hide]:hidden ${className}`}
      id="static-example"
      role="alert"
      aria-live="assertive"
      aria-atomic="true"
