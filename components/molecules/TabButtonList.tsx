...
const TabButtonList: React.FC<TabButtonListProps> = ({
  ...
  return (
    <div className={styles["tab-buttons"]}>
      ...
      />
      <TabButton
        active={activeTab === Tab.WithDependencies}
        onClick={() => onTabChange(Tab.WithDependencies)}
        label="Pendentes"
      />
      <TabButton
        active={activeTab === Tab.DiagnosedWithDisease}
        onClick={() => onTabChange(Tab.DiagnosedWithDisease)}
        label="Diagnosed"
      />
    </div>
  );
