        ...
        <div
          ...
          <ul role="list" className="divide-y divide-gray-100">
            {pacientes.map((paciente: Paciente) =>
              <li key={paciente.prontuario} className="flex justify-between gap-x-6 py-5">
                <div className="flex gap-x-4">
                  <Image className="h-24 w-24 flex-none rounded-full bg-gray-50" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" width="250" height="250" alt="Estado do paciente" />
                  <div className="min-w-0 flex-auto">
                    <p className="text-sm font-semibold leading-6 text-gray-900 text-2xl">{paciente.name}</p>
                    <p className="mt-1 truncate text-xs leading-5 text-gray-500 text-base">Prontuário: {paciente.prontuario}</p>
                  </div>
                </div>
                <div className="hidden sm:flex sm:flex-col sm:items-center">
                  <Image className="h-12 w-auto flex-none rounded-full" src={paciente?.neutropeniaFebril ? febre : medicamento} alt="" width="50" height="50" />
